...
console.log(formIsValid);
  ...
  return (
      ...
      <FormElement label={{ for: "VO", text: "Numero VO" }} input={{ type: "number", name: "VO", id: "VO" ,onChange:(e) =>  setDetailValues({ ...detailValues, [e.target.name]: e.target.value <= 11 ? e.target.value : e.target.value.slice(0,11)})}} value={detailValues.VO} required={true} />
