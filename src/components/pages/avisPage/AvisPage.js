  ...
  return (
    <div>
      ...
      <form className='form' onSubmit={handleSubmit} >
            <FormElement label={{ for: "name", text: "Prénom" }} input={{className:"width-formInpt_noFlex", type: "text", name: "name", id: "name", onChange:(e)=> setName(e.target.value.slice(0,25)) }} maxLength={18} value={name.slice(0,25)} required={true} />
            <FormElement label={{ for: "message", text: "Commentaire" }} textarea={{className:"width-formInpt_noFlex", name: "message", id: "message",  onChange: (e) => setMessage(e.target.value.slice(0,255)) }}  maxLength={255}  value={message.slice(0,255)} required={true}/>
